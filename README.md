...
- [ ] Explain what a token is used for.
  ...
  A token is used to validate authentication for that particular user, it gets stored in localstorage and is athenticated with the server when a user logs in.

- [ ] What steps can you take in your web apps to keep your data secure?

  One can add private routes that are only for the a user with a token.

- [ ] Describe how web servers work.

  Web servers are scattered all across the globe, they provide an interconnected network that pass data to each other. One example of the use of web servers is the internet. Our local servers have an API built in them and they provide data as well as functions that respond when we call any of our CRUD calls.
